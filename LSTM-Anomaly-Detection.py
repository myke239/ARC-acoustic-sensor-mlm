...
leak_data_fp = dir_path + "/data/FOS - 5.19.20/wireshark/leak large vertical section/sensorDataRaw.csv"
little_leak_data_fp = dir_path + "/data/FOS - 5.19.20/wireshark/leak small vertical/sensorDataRaw.csv"
c3_leak_fp = dir_path + "/data/FOS - 5.19.20/wireshark/coupon 3 hole unplugged/sensorDataRaw.csv"
c4_leak_fp = dir_path + "/data/FOS - 5.19.20/wireshark/coupon 4 hole unplugged/sensorDataRaw.csv"
pump_turning_on = dir_path + "/data/FOS - 5.19.20/wireshark/pump turning on/sensorDataRaw.csv"
normal_data_fp = dir_path + "/data/FOS - 5.19.20/wireshark/pump active normal/sensorDataRaw.csv"
normal_data_2_fp = dir_path + "/data/FOS - 5.19.20/wireshark/pump active normal 2/sensorDataRaw.csv"
bypass_valve_fp = dir_path + "/data/FOS - 5.19.20/wireshark/valve turned/sensorDataRaw.csv"
main_valve_fp = dir_path + "/data/FOS - 5.19.20/wireshark/valve partially closed/sensorDataRaw.csv"
tank_empty_fp = dir_path + "/data/FOS - 5.19.20/wireshark/tank emptying/sensorDataRaw.csv"
tape_leak_data_fp= dir_path + "/data/FOS - 5.19.20/wireshark/leak tape weak vertical/sensorDataRaw.csv"
